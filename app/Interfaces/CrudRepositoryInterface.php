...
interface CrudRepositoryInterface
{
    ...
    public function store(Model $model, $data, $request, $folder = null, $files = [], array $images = [], array $modified_values = []);

   public function update(Model $model, array $data, $id, $request = [],  $folder = null,$files = [], array $images = [], $modified_values = [],  $hashing_values = null,  array $where = [], array $whereNot = [], array $search = [], $active = null, $verify = null);
